...
let
  ...
  */
  ...
  CGI = buildPerlPackage {
    ...
    buildInputs = [ TestTester TestDeep TestNoWarnings TestWarn ];
  ...
  DBDmysql = buildPerlPackage {
    ...
    src = fetchurl {
      url = https://www.cpan.org/modules/by-module/DBD/DBD-mysql-4.033.tar.gz;
 ...
 JSONWebToken = buildPerlModule {
  ...
  SDL = buildPerlModule {
    ...
    buildInputs = [ AlienSDL CaptureTiny TestDeep TestDifferences TestException TestMost TestWarn ]
      ++ (with pkgs; [ SDL SDL_gfx SDL_mixer SDL_image SDL_ttf SDL_net ] );
...
meta = {
  ...
  TryTiny = buildPerlPackage {
    ...
    version = "0.24";
    src = fetchurl {
      url = mirror://cpan/authors/id/E/ET/ETHER/Try-Tiny-0.24.tar.gz;
      sha256 = "10cdyckci08lnqx2szx9a8j1xh2yqayynsak2wyrfmh29kr1lylv";
    };
  ...
  ModuleMetadata = buildPerlPackage rec {
    pname = "Module-Metadata";
    version = "1.000037";
    src = fetchurl {
      url = "mirror://cpan/authors/id/E/ET/ETHER/Module-Metadata-1.000037.tar.gz";
...
#  MIMEBase64 = self.MIMEBase64; # part of Perl 5.22
