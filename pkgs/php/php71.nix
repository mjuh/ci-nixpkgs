...
stdenv.mkDerivation {
  ...
  version = "7.1.32";
  src = fetchurl {
    url = "http://www.php.net/distributions/php-7.1.32.tar.bz2";
  ...
  preCheck = [
    ...
    ''
    ''
      for file in  ext/curl/tests/curl_basic_010.phpt ext/intl/tests/breakiter_getLocale_basic2.phpt ext/intl/tests/locale_bug66289.phpt ext/intl/tests/locale_get_display_language.phpt ext/intl/tests/locale_get_display_name5.phpt ext/intl/tests/locale_get_primary_language.phpt ext/intl/tests/locale_parse_locale2.phpt ext/standard/tests/network/dns_get_mx.phpt ext/cli/tests/upload_2G.phpt; do
        rm $file || true
      done
    ''
    ''
  ...
  configureFlags = [
    ...
    "--with-pcre-regex=${pcre.dev}"
    "PCRE_LIBDIR=${pcre.dev}"
  ];
}
