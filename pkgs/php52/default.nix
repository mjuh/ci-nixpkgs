...
, libxml2, libxslt, pam, pcre, postfix, readline, sqlite, t1lib, zlib, withOpenSSL102, libxpm-lib-dev, findutils, gnugrep, gnused }:
...
stdenv.mkDerivation rec {
 ...
 configureFlags = [
    ...
    "--with-bz2=${bzip2.dev}"
    "--with-config-file-scan-dir=/etc/php52.d/"
