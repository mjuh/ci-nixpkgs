...
let
  ...
  testDiffPy = sampleJson: output: phpVersion: writeScript "test-php-diff.py" ''
...
import maketest ({ pkgs, lib, ... }: {
  ...
  testScript = [
    ''
          ...
          $docker->succeed("${testDiffPy (./. + "/${phpVersion}.json") "deepdiff.html" phpVersion}");
          $docker->succeed("${testDiffPyWithExcludes (./. + "/${phpVersion}.json") "deepdiff-with-excludes.html" phpVersion}");
          $docker->succeed("${testDiffPy (./. + "/web34/${phpVersion}.json") "deepdiff-web34.html" phpVersion}");
