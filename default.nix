...
let
  majordomoPkgs = rec {
    ...
    TextTruncate = mjperl5Packages.TextTruncate;
    TimeLocal = mjperl5Packages.TimeLocal;
    PerlMagick = mjperl5Packages.PerlMagick;
    commonsense = mjperl5Packages.commonsense;
    Mojolicious = mjperl5Packages.Mojolicious;
    base = mjperl5Packages.base;
    libxml_perl = mjperl5Packages.libxml_perl;
    libnet = mjperl5Packages.libnet;
    libintl_perl = mjperl5Packages.libintl_perl;
    LWP = mjperl5Packages.LWP;
    ListMoreUtilsXS = mjperl5Packages.ListMoreUtilsXS;
    LWPProtocolHttps = mjperl5Packages.LWPProtocolHttps;
    DBI = mjperl5Packages.DBI;
    DBDmysql = mjperl5Packages.DBDmysql;
    CGI = mjperl5Packages.CGI;
    FilePath = mjperl5Packages.FilePath;
    DigestPerlMD5 = mjperl5Packages.DigestPerlMD5;
    DigestSHA1 = mjperl5Packages.DigestSHA1;
    FileBOM = mjperl5Packages.FileBOM;
    GD = mjperl5Packages.GD;
    LocaleGettext = mjperl5Packages.LocaleGettext;
    HashDiff = mjperl5Packages.HashDiff;
    JSONXS = mjperl5Packages.JSONXS;
    POSIXstrftimeCompiler = mjperl5Packages.POSIXstrftimeCompiler;
    perl = mjperl5Packages.perl;
